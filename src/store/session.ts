...
export interface ActiveRoll {
  ...
  // shots, ready to mint). Set automatically when the last frame is shot — a
  // roll is shot to the end before it develops, like real film.
  developed: boolean
...
export const useSessionStore = create<SessionStore>()((set, get) => {
  ...
  return {
    ...
    // Develop = close the roll to further shots. Fired automatically once the
    // roll is fully shot; there is no manual develop action.
    developRoll: () => {
