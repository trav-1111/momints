...
export default function GalleryScreen() {
  ...
  // hidden (in the roll card / develop screen), never in this grid.
  ...
  // Develop (close) the open roll, then go review its frames.
  const handleDevelopRoll = useCallback(() => {
    developRoll()
    router.push('/develop')
  }, [developRoll, router])
          ...
          ListHeaderComponent={
            activeRoll && !selectMode ? (
              <RollCard
                ...
                onDevelop={handleDevelopRoll}
                onReviewMint={() => router.push('/develop')}
